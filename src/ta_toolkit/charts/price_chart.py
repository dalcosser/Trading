...
def plot_candles_with_signal(
    ...
    fig.update_xaxes(showgrid=True, gridcolor=grid_color, zerolinecolor=grid_color, tickfont_color="#e6e6e6" if dark_mode else "#111111", titlefont_color="#e6e6e6" if dark_mode else "#111111")
    fig.update_yaxes(showgrid=True, gridcolor=grid_color, zerolinecolor=grid_color, tickfont_color="#e6e6e6" if dark_mode else "#111111", titlefont_color="#e6e6e6" if dark_mode else "#111111")
